...
#else
// WASM: qg_dialogfactory.h lives in the QtWidgets UI layer. The
// QG_DIALOGFACTORY macro is identical to RS_DIALOGFACTORY (both resolve to
// RS_DialogFactory::instance()->getFactoryObject()), already available via
// rs_dialogfactory.h included below.
#define QG_DIALOGFACTORY RS_DIALOGFACTORY
#endif
